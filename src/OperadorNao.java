...
public class OperadorNao {
	...
	public static void main(String[] args) {
		 ...
		 * e caso esse tipo NÃO SEJA "administrador", 
		 * exibir a mensagem: "Atenção, usuário sem poderes administrativos. Algumas tarefas serão bloqueadas".*/
		...
		//Operador ! que inverte o estado lógico. Se for falso, vai ser verdadeiro e viceversa. 
